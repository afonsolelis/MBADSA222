...
# Material Complementar - MBA USP ESALQ
...
# Alternativamente, é possível implementar os seguintes comandos individualmente no console:
# pip install factor_analyzer
# pip install pingouin

## O pacote factor_analyzer é para a geração da Análise Fatorial PCA
## O pacote pingouin é para a criação da matriz de correlações de Pearson
## Neste caso, os pacotes pandas, seaborn, numpy e matplotlib já devem estar instalados previamente 
